...
object ShardingEventJournal {
  def props = Props[ShardingEventJournal]
  def name: String = "ShardingEventJournal"

  val shardName: String = "ShardingEventJournal"
...
class ShardingEventJournal () extends EventJournalActor () {
