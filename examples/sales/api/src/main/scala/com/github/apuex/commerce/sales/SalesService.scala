  ...
  override def descriptor: Descriptor = {
    ...
    named("sales")
      .withCalls(
        ...
        pathCall("/api/event-journal/delete-event-journal", deleteEventJournal _),
        pathCall("/api/event-journal/query-event-journal", queryEventJournal _),
        pathCall("/api/event-journal/retrieve-event-journal-by-rowid/:rowid", retrieveEventJournalByRowid _)
      ).withAutoAcl(true)
  }
}
